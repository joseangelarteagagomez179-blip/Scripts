--[[
    ...
    - PC: Presiona la tecla 'F' para activar/desactivar. Usa las teclas
      W, A, S, D para desplazarte por el mapa.
...
-- Control de Velocidad (Botones + y -)
...
-- Loop de Movimiento Sincronizado
